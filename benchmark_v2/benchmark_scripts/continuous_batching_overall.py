...
if __name__ == "__main__":
    ...
    # Benchmark with high number of samples, asynchronous batching and decdode fast path
    results.append(run_and_parse_cb_example("--samples 500 --use-async --block-table 32"))
